...
function mainProcess(){
	fs.readdir('../node_pdf_test'/* Directory Name */, function(err,files) {
		...
		files.forEach(function(fileName) {
			...
			var file = path.join(__dirname,'../node_pdf_test' /* Directory Name */ ,fileName),
				newPath = path.join(__dirname,'../node_pdf_test/test/');
